...
print('connecting to judge')
soc.connect(('10.83.140.163', 6666))
print('connected')
...
class Thread1(QThread):        # 线程1
    ...
    def detect(self,save_img=True):
        ...
        script_path='/home/jetson/astra/pyorbbecsdk/examples/save_image_plus_circle.py'
    ...
    def run(self):
        ...
        if not os.path.exists(save):
            os.makedirs(save)
            file = open('/home/jetson/Desktop/result_m/WHUT-A+Moreplus-R4.txt','w')
            file.close()
        path_item = os.path.join(path, 'color0.txt')
        path_item2 = os.path.join(save, 'WHUT-A+Moreplus-R4.txt')  # 保存的路径
        print('Start Process!')
        measure_circle.measure('/home/jetson/yolo/yolov5-5.0/data/capread/color_images/color0.jpg', path_item, path_item2)
        print('Process Over!')
